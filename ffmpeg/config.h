...
#define FFMPEG_CONFIGURATION "--enable-libx264 --enable-gpl --enable-shared --enable-avresample --enable-postproc --enable-ffplay --enable-debug --prefix=/usr/local/ffmpeg --enable-pthreads --enable-libmp3lame --enable-libtheora --enable-libxvid --enable-x11grab"
